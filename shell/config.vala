...
class Config : Object {
    ...
    public string? bluetooth_manager_command { get; set; }
    ...
    private void set_defaults() {
        ...
        bluetooth_manager_command = null;
    ...
    private void read_root_node(Json.Node node) throws Error {
        ...
        read_string_or_null(obj, "bluetooth_manager_command", "bluetooth-manager-command");
    }
